...
// Demo login route
router.post('/demo/login/admin', express.json({ strict: false }), authController.demoLogin);

// Profile routes (protected)
router.get('/profile', authenticate(['admin']), authController.profile);
router.put('/profile', authenticate(['admin']), authController.updateProfile);
