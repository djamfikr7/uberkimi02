...
// Demo login route
router.post('/demo/login/driver', express.json({ strict: false }), authController.demoLogin);

// Profile routes (protected)
router.get('/profile', authenticate(['driver']), authController.profile);
router.put('/profile', authenticate(['driver']), authController.updateProfile);
