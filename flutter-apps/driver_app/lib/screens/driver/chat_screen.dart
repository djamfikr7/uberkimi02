...
import 'package:driver_app/theme/app_theme.dart' as driver_theme;
    ...
    socket.on('message_error', (data) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          ...
          backgroundColor: driver_theme.AppTheme.errorColor,
        ),
      );
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: driver_theme.AppTheme.primaryColor,
